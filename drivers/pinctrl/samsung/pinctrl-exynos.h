...
#define EXYNOS8890_PIN_BANK_EINTG(pins, reg, id, offs)		\
	{							\
		.type		= &exynos8890_bank_type_off,	\
		.pctl_offset	= reg,				\
		.nr_pins	= pins,				\
		.eint_type	= EINT_TYPE_GPIO,		\
		.eint_offset	= offs,				\
...
#define EXYNOS8890_PIN_BANK_EINTW(pins, reg, id, offs)		\
	{							\
		.type		= &exynos8890_bank_type_alive,	\
		.pctl_offset	= reg,				\
		.nr_pins	= pins,				\
		.eint_type	= EINT_TYPE_WKUP,		\
		.eint_offset	= offs,				\
