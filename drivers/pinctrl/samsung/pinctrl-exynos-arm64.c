...
/* Exynos8890 has the 3bit widths for PINCFG_TYPE_DRV bitfields. */
static struct samsung_pin_bank_type exynos8890_bank_type_off  = {
	.fld_width = { 4, 1, 2, 3, 2, 2, },
	.reg_offset = { 0x00, 0x04, 0x08, 0x0c, 0x10, 0x14, },
};

/* Exynos8890 has the 3bit widths for PINCFG_TYPE_DRV bitfields. */
static struct samsung_pin_bank_type exynos8890_bank_type_alive = {
	.fld_width = { 4, 1, 2, 3, },
	.reg_offset = { 0x00, 0x04, 0x08, 0x0c, },
};
...
static const struct samsung_pin_bank_data exynos8890_pin_banks0[] __initconst = {
	/* Must start with EINTG banks, ordered by EINT group number. */
	EXYNOS8890_PIN_BANK_EINTW(8, 0x000, "gpa0", 0x00),
	EXYNOS8890_PIN_BANK_EINTW(8, 0x020, "gpa1", 0x04),
	EXYNOS8890_PIN_BANK_EINTW(8, 0x040, "gpa2", 0x08),
	EXYNOS8890_PIN_BANK_EINTW(8, 0x060, "gpa3", 0x0c),
};

/* pin banks of exynos8890 pin-controller 1 (AUD) */
static const struct samsung_pin_bank_data exynos8890_pin_banks1[] __initconst = {
	/* Must start with EINTG banks, ordered by EINT group number. */
	EXYNOS8890_PIN_BANK_EINTG(7, 0x000, "gph0", 0x00),
};
...
static const struct samsung_pin_bank_data exynos8890_pin_banks5[] __initconst = {
	/* Must start with EINTG banks, ordered by EINT group number. */
	EXYNOS8890_PIN_BANK_EINTG(4, 0x000, "gpi1", 0x00),
	EXYNOS8890_PIN_BANK_EINTG(8, 0x020, "gpi2", 0x04),
};
...
static const struct samsung_pin_bank_data exynos8890_pin_banks8[] __initconst = {
	/* Must start with EINTG banks, ordered by EINT group number. */
	EXYNOS8890_PIN_BANK_EINTG(6, 0x000, "gpi0", 0x00),
	EXYNOS8890_PIN_BANK_EINTG(8, 0x020, "gpd0", 0x04),
	EXYNOS8890_PIN_BANK_EINTG(6, 0x040, "gpd1", 0x08),
	EXYNOS8890_PIN_BANK_EINTG(4, 0x060, "gpd2", 0x0c),
	EXYNOS8890_PIN_BANK_EINTG(4, 0x080, "gpd3", 0x10),
	EXYNOS8890_PIN_BANK_EINTG(2, 0x0A0, "gpb1", 0x14),
	EXYNOS8890_PIN_BANK_EINTG(2, 0x0C0, "gpb2", 0x18),
	EXYNOS8890_PIN_BANK_EINTG(3, 0x0E0, "gpb0", 0x1C),
	EXYNOS8890_PIN_BANK_EINTG(5, 0x100, "gpc0", 0x20),
	EXYNOS8890_PIN_BANK_EINTG(5, 0x120, "gpc1", 0x24),
	EXYNOS8890_PIN_BANK_EINTG(6, 0x140, "gpc2", 0x28),
	EXYNOS8890_PIN_BANK_EINTG(8, 0x160, "gpc3", 0x2C),
	EXYNOS8890_PIN_BANK_EINTG(4, 0x180, "gpk0", 0x30),
	EXYNOS8890_PIN_BANK_EINTG(7, 0x1A0, "etc1", 0x34),
};
...
static const struct samsung_pin_bank_data exynos8890_pin_banks9[] __initconst = {
	/* Must start with EINTG banks, ordered by EINT group number. */
	EXYNOS8890_PIN_BANK_EINTG(8, 0x000, "gpe0", 0x00),
	EXYNOS8890_PIN_BANK_EINTG(8, 0x020, "gpe5", 0x04),
	EXYNOS8890_PIN_BANK_EINTG(8, 0x040, "gpe6", 0x08),
	EXYNOS8890_PIN_BANK_EINTG(8, 0x060, "gpj1", 0x0c),
	EXYNOS8890_PIN_BANK_EINTG(2, 0x080, "gpj2", 0x10),
	EXYNOS8890_PIN_BANK_EINTG(8, 0x0A0, "gpe2", 0x14),
	EXYNOS8890_PIN_BANK_EINTG(8, 0x0C0, "gpe3", 0x18),
	EXYNOS8890_PIN_BANK_EINTG(8, 0x0E0, "gpe4", 0x1C),
	EXYNOS8890_PIN_BANK_EINTG(8, 0x100, "gpe1", 0x20),
	EXYNOS8890_PIN_BANK_EINTG(4, 0x120, "gpe7", 0x24),
	EXYNOS8890_PIN_BANK_EINTG(3, 0x140, "gpg0", 0x28),
};
...
static const struct samsung_pin_bank_data exynos8890_pin_banks10[] __initconst = {
	/* Must start with EINTG banks, ordered by EINT group number. */
	EXYNOS8890_PIN_BANK_EINTG(3, 0x000, "gpf1", 0x00),
};
